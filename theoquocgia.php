...
if($_REQUEST["maqg"]<>"")
{
	...
	$sql="select * from bai_hat, ca_si, quoc_gia where bai_hat.ma_quoc_gia=$ma_quoc_gia and bai_hat.ma_ca_si=ca_si.ma_ca_si and bai_hat.ma_quoc_gia=quoc_gia.ma_quoc_gia order by bai_hat.luot_xem desc limit $start, $limit";
	$result=$DB->query($sql);
	...
	?>	
		...
		<div class="wrap-content">            
            <div class="section mt20">
				<h2 class="title-section">
					<a href="#"><?php echo ucfirst($row2[ten_quoc_gia]);?> Có <?php echo $count;?> ca khúc <i class="icon-arrow"></i></a>
				</h2>
