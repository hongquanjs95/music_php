...
<form action="" method="post" enctype="multipart/form-data">
  <table width="100%" border="0" cellspacing="1" cellpadding="1">
    <tr>
      <td align="center">&nbsp;</td>
      <td class="tieude" align="center">THÊM BÀI HÁT </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><select name="nhac_si" id="nhac_si" class="bootstrap-select">
    ...
    <tr>
      ...
      <td><select name="the_loai" id="the_loai" class="bootstrap-select">
